...
wss.on("connection", (ws) => {
  ...
  ws.send(JSON.stringify({ type: "INITIAL_DATA", data: shipments }));
  ...
  const interval = setInterval(() => {
    ...
    randomShipment.status = newStatus;

    // Send the updated shipment to the client
    ws.send(JSON.stringify({ type: "STATUS_UPDATE", data: randomShipment }));
